...
public class ClientGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextField_nombres1 = new javax.swing.JTextField();
        ...
        jLabel_tipocliente.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_tipocliente.setForeground(new java.awt.Color(204, 102, 0));
        jLabel_tipocliente.setText("Tipo de Cliente:");
        ...
        jPanelFormularioLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFormularioLayout.createSequentialGroup()
                            ...
                            .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanelFormularioLayout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(jTextField_nombres1)))))
                        .addGroup(jPanelFormularioLayout.createSequentialGroup()
                            .addContainerGap()
                            .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelFormularioLayout.createSequentialGroup()
                        .addGap(20, 20, 20)
                        .addComponent(jTextField_id, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(92, 92, 92))
        );
                ...
                .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelFormularioLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel_nombre)
                            .addComponent(jTextField_nombres1, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelFormularioLayout.createSequentialGroup()
                                .addComponent(jLabel_paterno)
 ...
 public void limpiarJTextField(){
    ...
    public void AddOneReporteData(){
        Object[] fila = new Object[7];
                    fila[0] = jTextField_nombres1.getText();
    ...
    public void updateOneReporteData(int rowSelected){
        Object[] fila = new Object[7];
                    jTableCliente.setValueAt(jTextField_nombres1.getText(), rowSelected, 0);
                    jTableCliente.setValueAt(jTextField_paterno.getText(), rowSelected, 1);
                    jTableCliente.setValueAt(jTextField_materno.getText(), rowSelected, 2);
                    jTableCliente.setValueAt(jTextField_numero.getText(), rowSelected, 3);
                    jTableCliente.setValueAt(jTextField_usuario.getText(), rowSelected, 4);
                    jTableCliente.setValueAt("********", rowSelected, 5);
                    jTableCliente.setValueAt(jTextField_id.getText(), rowSelected, 6);
    ...
    private void jButton_grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_grabarActionPerformed
         if(jTextField_id.getText().equals("")||
           ...
           jPasswordField_paswd.getText().equals("")
            ...
            Client w = new Client();
            w.setPerson_nombres(jTextField_id.getText());
            ...
            w.setClient_tipo("0");
            w.setClient_codigocliente("codigo");            
    ...
    private void jTableClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableClienteMouseClicked
        ...
        String usuario  = jTableCliente.getValueAt(row, 4).toString();
        String id       = jTableCliente.getValueAt(row, 6).toString();

        jTextField_id.setText(nombres);
    ...
    private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActualizarActionPerformed
        ...
        if(jTextField_id.getText().equals("")||
            ...
            Client c = new Client();
            c.setPerson_nombres(jTextField_id.getText());
            ...
            c.setClient_codigocliente("0");
            c.setClient_tipo("codigo");
